 ...
 * body function, giving it the current value, and finally call the update 
...
function loop(value, testFunc, updatedFunc, bodyFunc) {
    if (testFunc(value)) {
        bodyFunc(value);
        const newValue = updatedFunc(value);
        loop(newValue, testFunc, updatedFunc, bodyFunc);
    }
}
